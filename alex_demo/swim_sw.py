...
class Node:
	...
	def __init__(self, type, children = None, leaf = None):
		'''	Atttribute is composed of type, children, and leaf. 
			...
			5) 1                  => type : number    ,  leaf : number    ,  children = 1  (not a node, just constant)
			6) a                  => type : name      ,  leaf : name      ,  children = a  (not a node, just string)
...
def p_file_input(t):
	'''file_input : file_input ENDMARKER
				  | newline
				  | statement'''  
def p_statement(t):
...
def p_statement_if_else(t):
    'simple_statement : IF expression DO expression ELSE expression'
...
def p_expression_unistring(t):
    ...
    t[0].do = MethodType(do, t[0], Node)        
def p_expression_defun(t):
    'fun_statement : fun ID group suite'
    t[0] = Node("defun", [t[2],[3],t[4]], 'fun')
    def do(self):
    	names[t[2]] = t[0]
    t[0].do = MethodType(do, t[0], Node)

def p_expression_suite(t):
	'''suite : newline'''	
