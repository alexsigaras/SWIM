...
_lr_productions = [
  ...
  ('start -> statement','start',1,'p_start','swim.py',123),
  ('start -> function','start',1,'p_start','swim.py',124),
  ('function -> ID LPAREN STRING RPAREN','function',4,'p_function','swim.py',134),
  ('statement -> ID ASSIGN expression','statement',3,'p_statement_assign','swim.py',145),
  ('statement -> expression EQUALS expression','statement',3,'p_statement_equals','swim.py',149),
  ('statement -> IF expression DO expression ELSE expression','statement',6,'p_statement_if_else','swim.py',153),
  ('statement -> expression','statement',1,'p_statement_expr','swim.py',158),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','swim.py',162),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','swim.py',163),
  ('expression -> expression MULTIPLY expression','expression',3,'p_expression_binop','swim.py',164),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','swim.py',165),
  ('expression -> expression POW expression','expression',3,'p_expression_binop','swim.py',166),
  ('expression -> expression MOD expression','expression',3,'p_expression_binop','swim.py',167),
  ('expression -> expression AND expression','expression',3,'p_expression_binop','swim.py',168),
  ('expression -> expression OR expression','expression',3,'p_expression_binop','swim.py',169),
  ('expression -> expression XOR expression','expression',3,'p_expression_binop','swim.py',170),
  ('expression -> NOT expression','expression',2,'p_expression_binop','swim.py',171),
  ('expression -> TRUE','expression',1,'p_expression_binop','swim.py',172),
  ('expression -> FALSE','expression',1,'p_expression_binop','swim.py',173),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','swim.py',201),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','swim.py',205),
  ('expression -> NUMBER','expression',1,'p_expression_number','swim.py',209),
  ('expression -> ID','expression',1,'p_expression_name','swim.py',214),
]
